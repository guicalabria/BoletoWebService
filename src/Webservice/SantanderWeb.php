 ...
 * @author    Guilherme Calabria Filho < guiga86@gmail.com >
   ...
   public $mensagem = '';
  	...
  	public function registrarBoleto($parametros, $token = false) 
  	{
         ...
         file_put_contents(DIREMPRESA.'Temporaria/reqDup'.$parametros['textoNumeroTituloBeneficiario'].'.xml',$requisicao);
      			...
      			{
      			   $this->erro = true;
      				  $this->mensagem = is_array($resultado) ? @$resultado['detail']['erro']['Mensagem'] ?: @$resultado['textoMensagemErro'] : 'Erro inesperado na resposta do Banco do Brasil';
